...
public class DAOAudio {
    ...
    private final String TABLE_NAME = "lve_audio";
    ...
    public ArrayList<Audio> getAllData(){
        createTable();
        ArrayList<Audio> resultat = new ArrayList<>();
        ...
        for(Integer j=0; j<count; j++){
            ...
            resultat.add(new Audio(id, urlacces, src, titre, auteur, duree, date, type_libelle, type_shortcode, mMipmap));
            //--
            cursor.moveToNext();
        }
    ...
    public boolean isAudioExists(String src){
        createTable();
        ArrayList<Audio> resultat = new ArrayList<>();
